...
function preload() {
  ...
  Animigo=loadAnimation ("correndoverde1.png","correndoverde2.png","correndoverde3.png","correndoverde4.png","correndoverde5.png","correndoverde6.png",)
...
function draw() {
 ...
 console.log(Spc.x)
  ...
  inimigo = createSprite(1000, 1000, 50, 50)
  
  inimigo.collide(ground)
  inimigo.collide(ground2)
  inimigo.collide(ground3)
  inimigo.velocityY = inimigo.velocityY + 0.5

  if(frameCount%130===0){
    inimigo = createSprite(500, 600, 50, 50)
